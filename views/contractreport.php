		...
		<div id="page-wrapper">
			<div class="container-fluid">
             ...
             <div class="col-xs-2 pull-right">
                          ...
                          <option  value="Activate" >Not End</option>
                                      ...
                                      date_default_timezone_set("Asia/Manila");
                                        ...
                                        foreach ($deployapplicants as $employee){
                                          ...
                                          echo "<tr>";
                                                ...
                                                echo "<td>".$employee['datestart']."</td>";  
                                                echo "<td>".$employee['datecontract']."</td>"; 
                                                if ($remainingmonth == 0 ){
                                                  echo "<td>".$remainingday." Day</td>";
                                                }
                                                else{
                                                  echo "<td>".$remainingmonth."</td>";
                                                }
                                                 echo "<td>".$employee['status']."</td>";
                                                   echo "<td><a href='".base_url()."EmployeeController/viewcontract_reportemployee/".$employee['employeeID']."' class='btn btn-primary btm-sm'>View Contract</a></td>";
                                          echo "</tr>";
                                             $sql = "UPDATE tblemployee SET status='End' where dateremain = '".$datecontract."' AND employeeID='".$employee['employeeID']."'";
                                                   $this->db->query($sql);

                                                 if ($employee['status'] == 'End'){
                                                  $sql2 = "UPDATE tblapplicant SET status= 12 where applicantID='".$employee['applicantID']."'";
                                                    $this->db->query($sql2);
                                                  }

                                                 if ($remainingmonth != 0){
                                                     $sql3 = "UPDATE tblemployee SET dateremain='".$datenow."' where MONTH(dateremain) < '".$currentmonth."' AND YEAR(dateremain) = '".$currentyear."' AND employeeID='".$employee['employeeID']."'";
                                                     $this->db->query($sql3);
                                                   }
                                                 else{
                                                     $sql4 = "UPDATE tblemployee SET dateremain='".$datenow."' where  dateremain < '".$datenow."' AND YEAR(dateremain) = '".$currentyear."' AND employeeID='".$employee['employeeID']."'";
                                                     $this->db->query($sql4);
                                                   }
                                         }
