            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-users"></i> Requirement
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="post" id="searched" action="client">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addrequirementmodal">Add Requirement</button>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal fade" id="addrequirementmodal" tabindex="-1" role="dialog" aria-labelledby="roomClabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="roomClabel">Add Requirement / <input type="button" name="Add" value="+ Add More" id="addrequirement" class="btn btn-primary" ></h4>
                                        </div>
                                        <form method="post" id="addrequirementform" action="<?php echo base_url();?>RequirementController/add_requirement">
                                            <table class="table table-sm table-inverse">
                                                ...
                                                <tbody class="requirementdetail">
                                                  <tr>
                                                    <td><input class="form-control requirement" name="requirement[]" id="requirement"  type="text"></td>
                                            ...
                                            <button type="button" id="validaterequirement" name="addrequirement" class="btn btn-success">Save</button>
                                            </div>
                                        </form>
                    ...
                    <div class="dataTable_wrapper" style="overflow:auto">
                        ...
                        <?php foreach ($requirements as $requirement){?>
                         <tr>
                            ...
                            <td><a href="#"  style="color:#23527C;background-color:transparent;border:transparent"  class="viewrequirement fa fa-gear" data-toggle="modal" data-target="#updaterequirementmodal" data-requirementid="<?php echo $requirement['requirementID']; ?>"> Edit</a></td>
                            <td><a href="#"  style="color:#23527C;background-color:transparent;border:transparent"  class="viewrequirement fa fa-gear" data-toggle="modal" data-target="#deleterequirementmodal" data-requirementid="<?php echo $requirement['requirementID']; ?>"> Delete</a></td>
                         </tr>
                        <?php } ?>
                                 ...
                                 <div class="modal fade" id="deleterequirementmodal" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <form method="post" id="deletelocationform" action="<?php echo base_url();?>RequirementController/delete_requirement">
                                        <div class="modal-body">
                                        <center>
                                                <input name="requirementid" type="hidden">
                                ...
                                <div class="modal fade" id="updaterequirementmodal" tabindex="-1" role="dialog" aria-labelledby="roomClabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="roomClabel">Update Requirement</h4>
                                        </div>
                                        <form method="post" id="updaterequirementform" action="<?php echo base_url();?>RequirementController/update_requirement">
                                            <table class="table table-sm table-inverse">
                                                <thead>
                                                    <tr>
                                                     <th>Requirement</th>
                                                ...
                                                <tbody >
                                                    <input name="requirementid" type="hidden">
                                                    <td><input class="form-control" name="requirement" type="text"></td>                         

                                                </tbody>
                                            </table>
                                            <div class="modal-footer">
                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Cancel</button>
                                            <button type="button"  name="updaterequirement" class="btn btn-success">Update</button>
                                            </div>
                                        </form>
...
<!--end-->
 ...
 <script src="<?php echo base_url().'assets/js/myscript.js' ?>"></script>
  <script src="<?php echo base_url().'js/validateforrequirement.js' ?>"></script>
