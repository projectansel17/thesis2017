                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper" style="overflow:auto">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        foreach ($scheduleemployee as $employee){
                                          ...
                                          echo "<tr>";
                                                ...
                                                echo "<td><a href='#'  data-toggle='modal' data-target='#scheduleemployeemodal' class='viewscheduleemployee btn btn-danger btm-sm' data-employeeid='".$employee['employeeID']."'>View Schedule</a</td>";
...
<div class="modal fade" id="scheduleemployeemodal">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      <h4 class="modal-title">Current/Previous Schedule</h4>
    </div>
    <div class="modal-body">
