                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper" style="overflow:auto">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody class="attendancedetail">
                                    <?php
                                        foreach ($viewattendanceemployee as $employee){
                                          echo "<tr>";
                                               ...
                                               switch ($employee['status']) {
                                                  case 'Activate':
                                                  case 'End':
                                                    echo "<td><a href='".base_url()."EmployeeController/view_reportattendance/".$employee['employeeID']."' class='btn btn-primary btm-sm'>View Detail</a></td>";
                                                    break;
                                                      default:
