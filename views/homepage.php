				...
				<div class="row">
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge"></div>
										<div><p style="font-size:17px;">Plot Applicant Schedule</p></div>
									</div>
								</div>
							</div>
							<a href="<?php echo site_url('ApplicantController/viewplotapplicantadmin') ?>">
								<div class="panel-footer">
									<span class="pull-left">View Applicant</span>
						...
						<div class="panel panel-green">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge"></div>
										<div><p style="font-size:20px;">Deploy Employee</p></div>
									</div>
								</div>
							</div>
							<a href="<?php echo site_url('EmployeeController/viewemployee'); ?>">
								<div class="panel-footer">
						...
						<div class="panel panel-red">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge">Client</div>
										<div></div>
									</div>
								</div>
							</div>
							<a href="<?php echo site_url('ClientController/client'); ?>">
								<div class="panel-footer">
					...
					<div class="col-lg-3 col-md-6">
						<div class="panel panel-yellow">
							...
							<a href="<?php echo site_url('UserController/users'); ?>">
								<div class="panel-footer">
