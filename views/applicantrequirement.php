				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li>
								<i class="fa fa-user"></i> Requirenent Applicant
							</li>s
						</ol>
					</div>
				</div>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper" style="overflow: auto; ">
                               ...
                               <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:auto;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($applicantrequirement as $requirement){
                                          ...
                                          echo "<tr>";
                                                ...
                                                echo "<td><a href='#' class='viewarequirementapplicant btn btn-primary btm-sm' data-toggle='modal' data-target='#requirementmodal' data-appid='".$requirement["applicantID"]."'>View Requirement</a></td>";
                                                if ($requirement['lackingrequirement'] == 'Completed')
                                                    echo "<td><a href='#' class='viewapplicant btn btn-success btm-sm' >Completed</a></td>";

                                                else{
                                                echo "<td><a href='#' class='viewarequirementapplicant btn btn-danger btm-sm' data-toggle='modal' data-target='#lackingrequirementmodal' data-appid='".$requirement["applicantID"]."'>Lacking Requirement</a></td>";
                                                }
                                  ...
                                  <div class="modal fade" id="requirementmodal" tabindex="-1" role="dialog" aria-labelledby="update schedule" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="updatestatus">Requirements</h4>
                                        </div>
                                        <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-10 col-lg-offset-1">
                                         <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                                            ...
                                            <div class="form-group">
                                              <label>List of Requirements</label>
                                                <input type="text" class="form-control" name="oldrequirement" readonly >
                                           </div>
                                    </div>
                                    <!-- /.modal-delete -->
                                </div>
                                <!-- /.modal-dialog -->
                                  ...
                                  <div class="modal fade" id="lackingrequirementmodal" tabindex="-1" role="dialog" aria-labelledby="update schedule" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="updatestatus">Lacking Requirements</h4>
                                        </div>
                                        <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-10 col-lg-offset-1">
                                         <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                                            <input type="hidden" name="applicantid" >
                                            <div class="form-group">
                                              <label>List of Lacking Requirements</label>
                                                <input type="text" class="form-control" name="lackingrequirement" readonly >
                                           </div>
                                    </div>
                                    <!-- /.modal-delete -->
                                </div>
