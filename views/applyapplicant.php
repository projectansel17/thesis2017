                ...
                <div class="col-lg-13">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                               ...
                               <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:auto;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Date Apply</th>
                                            <th>Resume</th>
                                            <th>Plotting Schedule</th>
                                          
                                        </tr>
                                    </thead>
                                    <tbody>
                             <?php
                                 foreach ($applyapplicant as $student){
                                        echo "<tr>";
                                        ...
                                        echo "<td>".$student['dateapply']."</td>";
                                        echo "<td><a href='/tekton/".$student['file']."' download class='btn btn-primary btm-sm'>View Resume</a></td>";
                                        if ($student['unread'] == 0 || $student['unread'] == 1)
                                        echo "<td><a href='#' class='viewapplyapplicant btn btn-danger btm-sm' data-toggle='modal'  data-target='#applyapplicantmodal' data-studentid='".$student["studentid"]."'>Action</a></td>";
                                        else
                                        echo "<td><a href='#' class='viewapplyapplicant btn btn-success btm-sm'>Action</a></td>";
                                        echo "</tr>";
                                     }     
                                 ?>
                                    </tbody>
                           ...
                           <div class="modal fade" id="applyapplicantmodal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                       ...
                                       <div class="row">
                                        <div class="col-lg-10 col-lg-offset-1">
                                         ...
                                         <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                                            ...
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input name="lastname" readonly class="form-control" >
                                            </div>
                                            <div class="form-group">
                                                <input name="contact" type="hidden" class="form-control" >
                                            </div>
                                            <div class="form-group">                                            
                                                <input name="emailadd" type="hidden" class="form-control" >
                                            </div>
                                            <div class="form-group">
