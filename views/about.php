...
<head>
    ...
    <title>Tekton Management - Cebu | Promotions</title>
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class=" logo">
                            <a href="index.php">
                               <img id="header-logo" src="<?php echo base_url(); ?>hotelpage/images/westview.png">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <!-- /.container -->
      ...
      <script src="<?php echo base_url(); ?>hotelpage/js/jquery.js"></script>
    

    <!-- Bootstrap Core JavaScript -->
     <script src="<?php echo base_url(); ?>hotelpage/js/bootstrap.min.js"></script>
