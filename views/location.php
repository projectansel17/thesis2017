                        ...
                        <div class="modal fade" id="addlocationmodal" tabindex="-1" role="dialog" aria-labelledby="roomClabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="addlocationform" action="<?php echo base_url();?>LocationController/add_location">
                        ...
                        <?php } ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="deletelocationform" action="<?php echo base_url();?>LocationController/delete_location">
                                        <div class="modal-body">
                                        <center>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="updatelocationform" action="<?php echo base_url();?>ClientController/update_location">
                                            <table class="table table-sm table-inverse">
                                                <thead>
                                                    <tr>
                                                     <th>Location Name</th>
                                                ...
                                                <tbody class="selectlocationdetail">
                                                    <input name="locationid" type="hidden">
...
<!--end-->
 ...
 <script src="<?php echo base_url().'assets/js/myscript.js' ?>"></script>
  <script src="<?php echo base_url().'js/validateforlocation.js' ?>"></script>
