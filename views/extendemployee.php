                                        ...
                                        foreach ($deployemployee as $employee){
                                          ...
                                          echo "<tr>";
                                             ...
                                             if ($employee['status'] == "End"){
                                                echo "<td><a href='#' class='viewcontractemployee btn btn-danger btm-sm' data-toggle='modal'  data-target='#extendmodal' data-employeeid='".$employee["employeeID"]."'>Extend</a></td>";
                                                }
                                             else{
                                                echo "<td><a href='#' class='viewcontractemployee btn btn-success btm-sm' >Extend</a></td>";
                                                }
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           ...
                                           <button  type='submit' id="extend_employee"  class='btn btn-primary' >Yes</button>
                                        </div>
                                    </form>
                                    </div>
                                    <!-- /.modal-delete -->
